...
export class Matrix3 {
  ...
  public multiply(m: Matrix3) {
    return this.multiplyMatrices(this, m);
  }

  public premultiply(m: Matrix3) {
  ...
  public transposeIntoArray(r: Float32Array) {
    const m = this._values;
  ...
  public setUvTransform(tx: number, ty: number, sx: number, sy: number,
  ...
  public rotateSelf(theta: number) {
  ...
  public translateSelf(tx: number, ty: number) {
  ...
  public toArray(array: Float32Array = new Float32Array(9), offset = 0) {
    const te = this._values;
  ...
  public clone() {
    return new Matrix3().fromArray(this._values);
  }
}
