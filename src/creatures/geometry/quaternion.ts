...
export class Quaternion {
  ...
  public static slerpFlat(dst: number[], dstOffset: number,
  ...
  public static multiplyQuaternionsFlat(dst: number[], dstOffset: number,
    src0: number[], srcOffset0: number,
    src1: number[], srcOffset1: number) {
  ...
  public setFromEuler(euler: Euler, update?: boolean) {
    ...
    const x = euler.x; const y = euler.y; const z = euler.z; const
      order = euler.order;
  ...
  public angleTo(q: Quaternion) {
    return 2 * Math.acos(Math.abs(clamp(this.dot(q), -1, 1)));
  }

  public rotateTowards(q: Quaternion, step: number) {
  ...
  public slerpQuaternions(qa: Quaternion, qb: Quaternion, t: number) {
  ...
  public fromArray(array: number[] | Float32Array, offset = 0) {
  ...
  public toArray(array: Float32Array = new Float32Array(4), offset = 0) {
