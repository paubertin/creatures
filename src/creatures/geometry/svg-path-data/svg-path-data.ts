import { encodeSVGPath } from './svg-path-data.encoder';
import { SVGPathDataParser } from './svg-path-data.parser';
import { SVGPathDataTransformer } from './svg-path-data.transformer';
import { TransformableSVG } from './transformable-svg';
...
export class SVGPathData extends TransformableSVG {
  ...
  pushCommand (command: SVGCommand) {
...
export {encodeSVGPath} from './svg-path-data.encoder';
export {SVGPathDataParser} from './svg-path-data.parser';
export {SVGPathDataTransformer} from './svg-path-data.transformer';