...
//
function get_arc_center(x1: number, y1: number, x2: number, y2: number, fa: number, fs: number, rx: number, ry: number, sin_phi: number, cos_phi: number) {
  // Step 1.
  //
...
export default function a2c(x1: number, y1: number, x2: number, y2: number, fa: number, fs: number, rx: number, ry: number, phi: number) {
